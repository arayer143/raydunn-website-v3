...
import { Check, X, Palette, Code, Rocket, Shield, Headphones } from "lucide-react"
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <section>
        ...
        <Tabs defaultValue={additionalFeatures[0].category} className="w-full">
          <TabsList className="flex justify-center mb-8 flex-wrap">
            {additionalFeatures.map((category, index) => (
              <TabsTrigger key={index} value={category.category} className="flex items-center">
