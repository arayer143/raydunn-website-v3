    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden py-8 px-4 sm:px-6">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center">
          <motion.h1
            className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight text-white mb-6"
          ...
          <motion.div
            className="mt-10 flex flex-wrap justify-center items-center gap-4 sm:gap-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <Card className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border-none max-w-[250px] mx-auto">
